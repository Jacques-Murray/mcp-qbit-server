...
class ToolService {
  ...
  async callTool(params) {
    ...
    const { name, arguments } = paramsValidation.data;
    ...
    try {
      ...
      const validatedArgs = tool.inputSchema.parse(arguments);
      ...
      console.error(`[ToolService] Error executing tool '${name}':`, error.message);
      return this.#createToolErrorResult(
